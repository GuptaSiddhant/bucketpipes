...
export interface APIEndpoints {
  ...
  commits: {
    ...
    getReport: (
      params: Params.CommitsGetReport
    ) => AsyncResponse<Schema.Report>;
    getReportsForCommit: (
  ...
  issue_tracker: {
    ...
    getVote: (
      params: Params.IssueTrackerGetVote
    ) => AsyncResponse<Schema.Error>;
    getWatch: (
  ...
  pullrequests: {
    ...
    getPatch: (
      params: Params.PullrequestsGetPatch
    ) => AsyncResponse<Schema.Any>;
    list: (
  ...
  refs: {
    ...
    deleteBranch: (
      params: Params.RefsDeleteBranch
    ) => AsyncResponse<Schema.Any>;
  ...
  reports: {
    ...
    getReport: (
      params: Params.ReportsGetReport
    ) => AsyncResponse<Schema.Report>;
    getReportsForCommit: (
  ...
  repositories: {
    ...
    getPatch: (
      params: Params.RepositoriesGetPatch
    ) => AsyncResponse<Schema.Any>;
    getPipeline: (
  ...
  snippets: {
    checkWatch: (
      params: Params.SnippetsCheckWatch
    ) => AsyncResponse<Schema.Any>;
    ...
    startWatch: (
      params: Params.SnippetsStartWatch
    ) => AsyncResponse<Schema.Any>;
    ...
    updateAt: (
      params: Params.SnippetsUpdateAt
    ) => AsyncResponse<Schema.Snippet>;
    updateComment: (
